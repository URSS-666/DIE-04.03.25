...
public class Pedido extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel4Precio = new javax.swing.JLabel();
        ...
        Cubierta1.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 210, 350, 280));
        ...
        jTable3.getColumnModel().getColumn(1).setCellEditor(new SpinnerEditor());
        jTable3.getModel().addTableModelListener(e -> {
            if (e.getColumn() == 1) {
                int row = e.getFirstRow();
                int quantity = (int) jTable3.getValueAt(row, 1);
                float price = (float) jTable3.getValueAt(row, 3) / quantity;
                jTable3.setValueAt(quantity * price, row, 3);
            }
        });
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        // Configurar el panel y mostrar la cubierta  
    ...
    // Verificar si jTable1 tiene pedidos
    ...
    jTextArea1.append("********** SAUZALITO RESTAURANTE **********\n");
    jTextArea1.append("Dirección: [Tu dirección aquí] \n");
    jTextArea1.append("Teléfono: +XXX XXXXXXXX \n");
    jTextArea1.append("-------------------------------------------\n");
    jTextArea1.append("  Producto \t\t Cantidad \t Precio\n");
    jTextArea1.append("-------------------------------------------\n");
    ...
    // Pie de factura con el total
    jTextArea1.append("-------------------------------------------\n");
    jTextArea1.append("Total a pagar: $" + total + "\n");
    jTextArea1.append("*******************************************\n");
    jTextArea1.append("Gracias por su compra. ¡Vuelva pronto!\n");
    ...
    private javax.swing.JLabel jLabel4Precio;
